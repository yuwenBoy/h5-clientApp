<template>
	<view class="mescroll-uni-warp">
		<scroll-view :id="viewId" class="mescroll-uni" :class="{'mescroll-uni-fixed':isFixed}" :style="{'height':scrollHeight,'padding-top':padTop,'padding-bottom':padBottom,'top':fixedTop,'bottom':fixedBottom,'left':fixedLeft}" :scroll-top="scrollTop" :scroll-with-animation="scrollAnim" @scroll="scroll" :scroll-y='scrollable' :enable-back-to-top="true">
...
<script>
	...
	export default {
		...
		computed: {
			...
			fixedLeft(){
				return 0
				// return this.isFixed ? (this.numLeft + this.windowBottom) + 'px' : 0
			},
